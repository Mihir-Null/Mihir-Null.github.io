# 💻 MiTerm — build terminal styled websites in minutes!

Highly customizable, easy-to-use, and minimal terminal styled website template, powered by Next.js.

Building a simple website with MiTerm only takes **minutes**, and you only need to work with **one** file: `config.json`. After you cloned this repository, simply run `yarn install && yarn dev` and start editing `config.json` to build your website!

MiTerm can be used to build a variety of websites:
...
<strong>MiTerm with different themes</strong>
</p>
...
## 🚀 Ship your MiTerm site in less than 5 minutes

MiTerm requires the `yarn` package manager. You can install `yarn` [here](https://classic.yarnpkg.com/lang/en/docs/install/).
...
This will install MiTerm to the current directory. You can start building your website with:
...
```bash
git clone <your_repo_url> && cd MiTerm
```
...
90% of MiTerm's configurations are done through the `config.json` file.
...
```javascript
{
  ...
  "email": // your email
  "ps1_hostname": "miterm" // hostname in prompt
